        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <div className="font-display font-black text-3xl">
              <span className="text-jubilee-gold">camp</span> <span className="text-jubilee-navy">jubilee</span>
            </div>
            <p className="text-jubilee-navy/50 text-xs tracking-widest uppercase mt-1">Rest. Restore. Rejoice.</p>
          </div>
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            <div className="text-4xl mb-3">🏕️</div>
            <h2 className="text-xl font-semibold text-jubilee-navy mb-2">You're all set!</h2>
    ...
    <div className="min-h-screen flex items-center justify-center bg-jubilee-cream p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-xl font-semibold text-jubilee-navy mb-1">
            Welcome{name ? `, ${name.split(" ")[0]}` : ""}!
          </h2>
          <p className="text-gray-500 text-sm mb-6">
            Create a password to finish setting up your Camp Jubilee account.
          </p>
